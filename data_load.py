...
def data_variable_generating():
    ...
    test_path = '/opt/ml/input/data/test/test.csv'
    map_path = '/opt/ml/input/data/map/misconception_mapping.csv'
    sub_path = '/opt/ml/input/data/sample_sub/sample_submission.csv'
